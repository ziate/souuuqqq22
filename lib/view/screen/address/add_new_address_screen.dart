...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (s) {
      Provider.of<LocationProvider>(context).setMapController(_controller);
      // Provider.of<LocationProvider>(context).setAddAddressData();
      Provider.of<LocationProvider>(context).setLocationController(
          '${Provider.of<LocationProvider>(context).address.name ?? ''}, '
          '${Provider.of<LocationProvider>(context).address.subAdministrativeArea ?? ''}, '
          '${Provider.of<LocationProvider>(context).address.isoCountryCode ?? ''}');
      s = false;
